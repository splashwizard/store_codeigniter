                    ...
                    <div class="tab-content">
                        <div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6"  id="more_colors" style="padding: 0px">
                                    <?php
                                    if($all_c){
                                        $mpid=$row['product_id'];
                                        $mpids = $this->db->query("SELECT pcimage FROM product WHERE product_id=$mpid");
                                        ...
                                        foreach($all_c as $p){
                                            ...
                                            <div class="col-md-12" style="margin-bottom:8px;padding: 0px">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="input-group demo2">
                                                        <img src="<?php echo base_url();?>product_color/<?php echo $pimg[$mpic]; ?>" style="width: 50px">
                                                    </div>
                                                </div>
                                                <span class="col-md-2">
                                                                    ...
                                                                    foreach ($option as $t => $op1) {
                                                                        ...
                                                                        <div>
                                                                            <div class="col-sm-10" style="display: flex">
                                                                                ...
                                                                                <input type="text" style="width:50%;" name="op_set<?php echo $row1['no']; ?>[]" value="<?php echo $op1; ?>" class="form-control required"  placeholder="<?php echo translate('Selection Name'); ?>">

                                                                                <input type="text" style="width:50%;" name="op_set_value<?php echo $row1['no']; ?>[]" value="<?php echo $option_values[$t]; ?>" class="form-control required"  placeholder="<?php echo translate('Added Cost $'); ?>">

                                                                                <input type="text" style="width:33%;" name="op_set_number<?php echo $row1['no']; ?>[]" value="<?php echo $option_number[$t]; ?>" class="form-control required"  placeholder="<?php echo translate('Qty. Available'); ?>">
                                                                            </div>
                                                                            <div class="col-sm-2">
...
<script type="text/javascript">
    ...
    $("#more_option_btn").click(function(){
        ...
        $("#more_additional_options").append(''
            ...
            +'    <div class="col-sm-5">'
            +'    <div class="col-sm-12">'
            +'        <div class="col-sm-12 options margin-bottom-10" style = "margin-bottom: 3px;"></div><br>'
            +'        <div class="btn btn-mint btn-labeled fa fa-plus pull-right add_op">'
            +'        <?php echo translate('add_options_for_choice');?></div>'
            +'    </div>'
            +'        <div class="col-sm-12 options">'
    ...
    $("#more_additional_options").on('click','.add_op',function(){
        ...
        $(this).closest('.col-sm-12').find(".options").append(''
            +'    <div>'
            +'        <div class="col-sm-10" style = "display: flex;">'
            +'          <input type="text" name="op_set'+co+'[]" class="form-control required"  style="width:50%;" placeholder="<?php echo translate('Selection Name'); ?>">'
            +'          <input type="text" name="op_set_value'+co+'[]" class="form-control required" style="width:50%;" placeholder="<?php echo translate('Added Cost $'); ?>">'
