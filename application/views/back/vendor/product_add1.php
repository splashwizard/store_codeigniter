                    ...
                    <div class="tab-content">
                    	...
                    	<div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border" id="brn" style="display:none;">
								...
								<p>Do not associate a brand name to products if you don not have permission to use the Brand Name</p>
...
<!--                            -->
                            <div class="form-group btm_border">
                                ...
                                <label class="col-sm-4 control-label" for="demo-hor-11"><?php echo translate('dimension(/inch)');?></label>

                                <div class="col-sm-2">

                                    <input type="number" name="length" min="0" data-role="Lengthinput" placeholder="<?php echo translate('Length');?>" class="form-control">

                                </div>
                                <div class="col-sm-2">

                                    <input type="number" name="width"  min="0" data-role="Widthinput" placeholder="<?php echo translate('Width');?>" class="form-control">

                                </div>
                                <div class="col-sm-2">

                                    <input type="number" name="height"  min="0" data-role="Heightinput" placeholder="<?php echo translate('Height');?>" class="form-control">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <label class="col-sm-4 control-label" for="demo-hor-11"><?php echo translate('Weight(/lb)');?></label>

                                <div class="col-sm-2">

                                    <input type="number" name="weight"  min="0" data-role="Weightinput" placeholder="<?php echo translate('Weight');?>" class="form-control">
...
<!--                            -->
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-5"  id="more_colors">

                                    <div class="col-md-12" style="margin-bottom:8px; padding: 0px;">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group demo2">
                                                ...
                                                <input type="file"  name="pcimage[]" class="form-control" />
                            ...
                            <div class="form-group btm_border" style="">
                                   ...
                                   <label class="col-sm-4 control-label" for="demo-hor-9"><?php echo translate('product_tax');?></label>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <select class="demo-chosen-select" name="tax_approve">
                        ...
                        <div id="customer_choice_options" class="tab-pane fade">
                            ...
                            <div class="form-group btm_border" id = "adding_btn">
...
<script>
    ...
    $("#more_btn").click(function(){
        ...
        $("#more_additional_fields").append(''
            ...
            +'        <input type="text" class="form-control required"  placeholder="<?php echo translate('field_name'); ?>">'

            +'    </div>'

            +'    <div class="col-sm-5">'

            +'        <textarea rows="9"  class="summernotes" data-height="100"></textarea>'
    ...
    $("#more_option_btn").click(function(){
        ...
        $("#more_additional_options").append(''
            ...
            +'        <div class="col-sm-12 options margin-bottom-10" style = "margin-bottom: 3px;"></div>'
            ...
            +'        <span class="remove_it_o rmo btn btn-danger btn-icon btn-circle icon-lg fa fa-times" id = "delete_option_item" onclick="delete_row(this)"></span>'
        ...
        set_select();
        // $("#more_option_btn").hide();

    });

    $( "#delete_option_item" ).click(function() {
        $("#more_option_btn").show();
    });
    ...
    $("#more_additional_options").on('click','.add_op',function(){
        ...
        $(this).closest('.col-sm-12').find(".options").append(''
            ...
            +'          <input type="text" name="op_set'+co+'[]" class="form-control required" style="width:33%;" placeholder="<?php echo translate('Selection Name'); ?>">'

            +'          <input type="text" name="op_set_value'+co+'[]" class="form-control required" style="width:33%;" placeholder="<?php echo translate('Added Cost $'); ?>">'

            +'          <input type="text" name="op_set_number'+co+'[]" class="form-control required" style="width:33%;" placeholder="<?php echo translate('Qty. Available'); ?>">'

            +'          <input type="text" name="op_set_number_init'+co+'[]" class="form-control required" value = "0" style="width:33%; display:none" placeholder="<?php echo translate('Qty. Available'); ?>">'
