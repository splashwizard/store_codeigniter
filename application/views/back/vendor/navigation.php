            ...
            <div class="nano">
                ...
                <div class="nano-content">
                    ...
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        <li <?php if($page_name=="product" || 
                            ...
                            <!--Menu list item-->
                                    <li <?php if($page_name=="inventory"){?> class="active-link" <?php } ?> >
                                        ...
                                        <a href="<?php echo base_url(); ?>vendor/inventory">
                                    ...
                                    <li <?php if($page_name=="shipping"){?> class="active-link" <?php } ?> >

                                        <a href="<?php echo base_url(); ?>vendor/shipping">
                                ...
                                <li <?php if($page_name=="product" ||
                                    ...
                                    <a href="#">
                                        <i class="fa fa-list"></i>
                                        <span class="menu-title"><?php echo translate('physical_products');?></span>
                                        <i class="fa arrow"></i>
                                    </a>
                                    <!--PRODUCT------------------>
					 ...
					 <li <?php if($page_name=="sales_tax"){?> class="active-link" <?php } ?>>

                            <a href="<?php echo base_url(); ?>vendor/sales_tax/">

                                <i class="fa fa-usd"></i>

                                    <span class="menu-title">

                                		<?php echo translate('add_sales_tax');?>
                        ...
                        <li <?php if($page_name=="reply_conversation"){?> class="active-link" <?php } ?>>

                            <a href="<?php echo base_url(); ?>vendor/reply_conversation/">
					...
					<!--<li <?php if($page_name=="manage_vendor"){?> class="active-link" <?php } ?> >
                            ...
                            <a href="<?php echo base_url(); ?>vendor/shipping_state">

                                <i class="fa fa-lock"></i>

                                <span class="menu-title">

                                	<?php echo translate('shipping_state');?>
