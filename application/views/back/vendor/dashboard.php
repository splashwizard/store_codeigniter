<link rel="stylesheet" href="<?php echo base_url(); ?>template/back//amcharts/style.css" />
<script src="<?php echo base_url(); ?>template/back/amcharts/amcharts.js"></script>
<script src="<?php echo base_url(); ?>template/back/amcharts/serial.js"></script>
	    		...
	    		<div class="inner_row m-row--no-padding">
	    			...
	    			<div class="col-md-4">
	    				<div class="adwidget chartwidget">
	    					<div class="m-widget14__header m--margin-bottom-30">
								<h3 class="m-widget14__title text-center"><?php echo translate('vendor_commission');?></h3>
	    			...
	    			<div class="col-md-8">
	    				<div class="adwidget chartwidget">
	    					<div class="col-sm-4">
		    					<div class="m-widget14__header m--margin-bottom-30">
									<h3 class="m-widget14__title text-center"><?php echo translate('total_sold');?></h3>
									<div class="text-center">
	    					...
	    					<div class="col-sm-4">
		    					<div class="m-widget14__header m--margin-bottom-30">
									<h3 class="m-widget14__title text-center"><?php echo translate('paid_by_customers');?></h3>
									<div class="text-center">
							...
							<div class="col-sm-4">
		    					<div class="m-widget14__header m--margin-bottom-30">
									<h3 class="m-widget14__title text-center"><?php echo translate('due_from_admin');?></h3>
									<div class="text-center">
