<style>.dismissButton{background-color:#fff;border:1px solid #dadce0;color:#1a73e8;border-radius:4px;font-family:Roboto,sans-serif;font-size:14px;height:36px;cursor:pointer;padding:0 24px}.dismissButton:hover{background-color:rgba(66,133,244,0.04);border:1px solid #d2e3fc}.dismissButton:focus{background-color:rgba(66,133,244,0.12);border:1px solid #d2e3fc;outline:0}.dismissButton:hover:focus{background-color:rgba(66,133,244,0.16);border:1px solid #d2e2fd}.dismissButton:active{background-color:rgba(66,133,244,0.16);border:1px solid #d2e2fd;box-shadow:0 1px 2px 0 rgba(60,64,67,0.3),0 1px 3px 1px rgba(60,64,67,0.15)}.dismissButton:disabled{background-color:#fff;border:1px solid #f1f3f4;color:#3c4043}
	...
	<title>Rayant's Marketplace</title>
	<!--STYLESHEET-->
	<!--=================================================-->
	<!--Roboto Font [ OPTIONAL ]-->
	<!--Bootstrap Stylesheet [ REQUIRED ]-->
	<link href="https://ryants.com/demo/store/template/back/css/bootstrap.min.css" rel="stylesheet">
	<!--Activeit Stylesheet [ REQUIRED ]-->
	<link href="https://ryants.com/demo/store/template/back/css/activeit.min.css" rel="stylesheet">
	<!--Font Awesome [ OPTIONAL ]-->
	<link href="https://ryants.com/demo/store/template/back/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet">
	<!--Animate.css [ OPTIONAL ]-->
	<link href="https://ryants.com/demo/store/template/back/plugins/animate-css/animate.min.css" rel="stylesheet">
	<!--Morris.js [ OPTIONAL ]-->
	<link href="https://ryants.com/demo/store/template/back/plugins/morris-js/morris.min.css" rel="stylesheet">
	<!--Switchery [ OPTIONAL ]-->
	<link href="https://ryants.com/demo/store/template/back/plugins/switchery/switchery.min.css" rel="stylesheet">
	<!--Bootstrap Table [ OPTIONAL ]-->
	<link href="https://ryants.com/demo/store/template/back/plugins/bootstrap-table/bootstrap-table.min.css" rel="stylesheet">
	<!--Bootstrap Select [ OPTIONAL ]-->
	<link href="https://ryants.com/demo/store/template/back/plugins/bootstrap-select/bootstrap-select.min.css" rel="stylesheet">
	<!--Summernote [ OPTIONAL ]-->
	<link href="https://ryants.com/demo/store/template/back/plugins/summernote/summernote.min.css" rel="stylesheet">
	<!--Bootstrap Tags Input [ OPTIONAL ]-->
	<link href="https://ryants.com/demo/store/template/back/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css" rel="stylesheet">
	<!--Chosen [ OPTIONAL ]-->
	<link href="https://ryants.com/demo/store/template/back/plugins/chosen/chosen.min.css" rel="stylesheet">
	<!--noUiSlider [ OPTIONAL ]-->
	<link href="https://ryants.com/demo/store/template/back/plugins/noUiSlider/jquery.nouislider.min.css" rel="stylesheet">
	<link href="https://ryants.com/demo/store/template/back/plugins/noUiSlider/jquery.nouislider.pips.min.css" rel="stylesheet">
	<!--Bootstrap Timepicker [ OPTIONAL ]-->
	<link href="https://ryants.com/demo/store/template/back/plugins/Bootstrap-timepicker/bootstrap-timepicker.min.css" rel="stylesheet">
	<!--Bootstrap Validator [ OPTIONAL ]-->
	<link href="https://ryants.com/demo/store/template/back/plugins/Bootstrap-validator/bootstrapValidator.min.css" rel="stylesheet">
	<!--Dropzone [ OPTIONAL ]-->
	<link href="https://ryants.com/demo/store/template/back/plugins/dropzone/dropzone.css" rel="stylesheet">
	<!--Demo script [ DEMONSTRATION ]-->
	<link href="https://ryants.com/demo/store/template/back/css/demo/activeit-demo.min.css" rel="stylesheet">
    <!--Countdown [ REQUIRED ]-->
	<link href="https://ryants.com/demo/store/template/back/css/countdown.css" rel="stylesheet">
	<!--SCRIPT-->
	<!--=================================================-->
	<!--jQuery [ REQUIRED ]-->
	<script src="https://ryants.com/demo/store/template/back/js/jquery-2.1.1.min.js"></script>
	<!--BootstrapJS [ RECOMMENDED ]-->
	<script src="https://ryants.com/demo/store/template/back/js/bootstrap.min.js"></script>
    <link href="https://ryants.com/demo/store/template/back/colorpicker/dist/css/bootstrap-colorpicker.min.css" rel="stylesheet">
	<!--Page Load Progress Bar [ OPTIONAL ]-->
    <script src="https://ryants.com/demo/store/template/back/colorpicker/dist/js/bootstrap-colorpicker.js"></script>

		<link rel="shortcut icon" href="https://ryants.com/demo/store/uploads/others/favicon.ico">
	<script>
	        function sound(type){
            document.getElementById(type).volume = 0.7;
            document.getElementById(type).play();
        }
    	</script>
<script type="text/javascript" charset="UTF-8" src="https://maps.google.com/maps-api-v3/api/js/37/5/common.js"></script>
<script type="text/javascript" charset="UTF-8" src="https://maps.google.com/maps-api-v3/api/js/37/5/util.js"></script>
<script type="text/javascript" charset="UTF-8" src="https://maps.google.com/maps-api-v3/api/js/37/5/geocoder.js"></script>
<script type="text/javascript" charset="UTF-8" src="https://maps.google.com/maps-api-v3/api/js/37/5/map.js"></script>
...
<script type="text/javascript" charset="UTF-8" src="https://maps.google.com/maps-api-v3/api/js/37/5/onion.js"></script>
<script type="text/javascript" charset="UTF-8" src="https://maps.google.com/maps-api-v3/api/js/37/5/controls.js"></script>
<script type="text/javascript" charset="UTF-8" src="https://maps.google.com/maps-api-v3/api/js/37/5/marker.js"></script>
...
<script src="https://maps.google.com/maps/api/js?v=3.exp&amp;signed_in=true&amp;callback=MapApiLoaded&amp;key="></script>
<meta name="viewport" content="width=device-width, initial-scale=1">
...
?>
 <style media="" data-href="https://ryants.com/demo/store/template/front/css/theme.css">/* --------------------------------------------------------------------------
...
#preloader-status {
  ...
  /*background: url("https://ryants.com/demo/store/template/front/css/../img/preloader.png") no-repeat 50% 20px;*/
}
#preloader-title {
  font-size: 10px;
  text-align: center;
...
.page-section.image.testimonials {
    display: none;
}
...
.header .navigation-wrapper {
  background-color: rgba(124, 194, 66, 1);
  /*border-top: 1px solid #e4e4e4;*/
}
.header .homenav {
  background-color: rgba(124, 194, 66, 0.8);
  /*border-top: 1px solid #e4e4e4;*/
}
...
/*.sf-menu > li:first-child {
	text-indent: -9999px;
	position: relative;
	background-image: url("https://ryants.com/demo/store/template/front/css/../img/home-icon.png");
...
.coming-soon .main-slider .page {
  background: transparent url("https://ryants.com/demo/store/template/front/css/../img/preview/slider/slide-3.jpg") no-repeat center center;
...
.message-box:after {
  ...
  bottom: 0;
  right: 0;
  background: url("https://ryants.com/demo/store/template/front/css/../../assets/img/overlay-banner.png") repeat center center;
}
...
.thumbnail-banner .media-link .img-bg {
  ...
  width: 100%;
  z-index: -1;
  background-image: url("https://ryants.com/demo/store/template/front/css/''");
...
.widget.shop-categories > .widget-content > ul > li {
  border-top: solid 1px rgba(35, 35, 35, 0.1);
  font-size: 18px;
}
...
.wishlist .table > tbody > tr > td.image {
	padding: 5px 0;
	text-align: center;
}
.wishlist .table > tbody > tr > td.image .media-link {
	float: none;
    border-radius: 50%;
    width: 60px;
    height: 60px;
...
.thumbnail.box-style-1:hover{
	box-shadow: 0px 0px 20px rgba(64, 64, 64, 0.3);
	transition: all 0.4s ease-in-out;
	border: none;
}
...
/* ========================================================================== */
/* 3.1 */
/* special products with small products -webkit-box 
/* ========================================================================== */
.special-products .product-list:nth-child(2) .special-products-title {
	background: #bbbbbb;
}
...
.product-box-sm{
	...
	box-shadow: 0 0 24px rgba(201, 201, 201, 0.75);
}
.product-box-sm:hover{
  	box-shadow: 0px 0px 7px rgba(201, 201, 201, 0.75);
    transition: all 0.4s ease-in-out;
    background: #fbfbfb;
}
...
.delivery-return-ship .container > div {
    display: inline-block;
    width: 33.33%;
    float: left;
}
.delivery-return-ship span {
    height: 42px;
    display: inline-block;
    margin-right: 15px;
    vertical-align: middle;
...
.page-loaded .authantic-icon, .page-loaded .cash-icon, .page-loaded .return-icon, .page-loaded .shipping-icon, .page-loaded .rapid-ssl, .page-loaded .nortan, .page-loaded .pci, .page-loaded .maestro, .page-loaded .amex, .page-loaded .visa, .page-loaded .master, .page-loaded .cod, .page-loaded .thankyou-stamp, .page-loaded .net-bank, .page-loaded .rupay, .page-loaded .phonepe-ftr-logo {
	background: url("https://ryants.com/demo/store/template/front/css/../img/footer-icons.png") no-repeat;
...
.delivery-return-ship .cash-icon {
    background-position: -94px -78px;
}
.delivery-return-ship .cash-icon {
    width: 34px;
}
.delivery-return-ship .return-icon {
    width: 44px;
}
.delivery-return-ship .return-icon {
    background-position: -133px -74px;
}
.delivery-return-ship .shipping-icon {
...
/* ========================================================================== */
/* 4.1 */
/* home category -webkit-box theme-1
/* ========================================================================== */
...
.product-single .colors input[type="radio"]:checked+label:after{ 
	font-family: FontAwesome;
    content: "\f00c";
    color: #313131;
    top: 2px;
...
/* ========================================================================== */
/* 4.1 */
/* product -webkit-box for recommendation
/* ========================================================================== */
.recommendation{
  margin-top: 0px;
}
...
.home1_category_box{
  position:relative;
  background:#fff;
  box-shadow: 0px 6px 24px rgba(169, 169, 169, 0.5);
}
...
.home1_category_box .nav-tabs li a span {
	-ms-transform: skewX(20deg);
    -webkit-transform: skewX(-20deg);
    -moz-transform: skewX(-20deg);
    transform: skewX(-20deg);
...
.p-item-type-zoom.p-item:hover .p-item-img img {
...
.hcartbtn {
    ...
    height: 50px;
    position: relative;
    background-image: url("https://ryants.com/demo/store/template/front/css/../img/cart-icon.png");
    background-repeat: no-repeat;
    background-position: center;
    background-size: auto;
    padding: 10px 0;
...
.speacial_probtn {
    ...
    color: #fff;
    text-transform: uppercase;
    box-shadow: 0 0 0 1px #7cc242;
} 
.speacial_probtn:hover,
.speacial_probtn:focus {
	box-shadow: 0 0 0 1px #7cc242;
	background-color: #fff;
	color: #7cc242;
	/*background-image: url("https://ryants.com/demo/store/template/front/css/../img/cart-icon-white.png");*/
}
...
.shop_probtn:hover span,
.shop_probtn:focus span {
	color: #7cc242;
}
.shop_probtn span {
...
.shop_probtn img.hoverimgshow,
.shop_probtn:hover img.normalimgshow,
.shop_probtn:focus img.normalimgshow {
	display: none !important;
}
.shop_probtn:hover img.hoverimgshow,
.shop_probtn:focus img.hoverimgshow {
	display: inline-block !important;
}
...
.featured-products-carousel .thumbnail.box-style-1 {
	padding-bottom: 15px;
}
...
.sidebar.close_now {
	box-shadow: 0 1px 24px hsla(0, 0%, 62.4%, 0.84);
	padding: 0px;
}
...
.widget.shop-categories ul label input[type="checkbox"]:checked + .cr,
.checkbox input[type="checkbox"]:checked + .cr{
	background: #7cc242;
	border-color: #7cc242;
    color: #fff;
}
.csscheckbox input[type="checkbox"]:checked + .cr:after{
	content: "\e013";
	font-family: 'Glyphicons Halflings';
	position: relative;
    top: -3px;
}
.searchresultcontent .thumbnail{
	margin: 0 auto 30px;
	box-shadow: 0 0 0 1px #eaeaea;
}
.searchresultcontent .thumbnail.box-style-1 .caption{
	padding: 0px 0 15px;
}
.breadcum_section {
    background: #fff;
    box-shadow: 0 5px 7px rgba(169, 169, 169, 0.156);
    margin-bottom: 30px;
}
...
.logfield .form-control:focus {
	border-color: #afafaf;
}
.logfield .form-control::-webkit-input-placeholder { /* Chrome/Opera/Safari */
	color: #9e9e9e;
}
.logfield .form-control::-moz-placeholder { /* Firefox 19+ */
	color: #9e9e9e;
}
.logfield .form-control:-ms-input-placeholder { /* IE 10+ */
  	color: #9e9e9e;
}
.logfield .form-control:-moz-placeholder { /* Firefox 18- */
  	color: #9e9e9e;
}
...
.contbtn {
    ...
    font-size: 18px;
    font-weight: 600;
    background-image: url("https://ryants.com/demo/store/template/front/css/../img/button-arrow.png");
...
.regtabber li.active a:after,
.regtabber .nav-tabs>li.active>a:focus:after, 
.regtabber .nav-tabs>li.active>a:hover:after {
	position: absolute;
    content: '';
    left: 0;
    bottom: -2px;
...
.prodes-tabs.regtabber li.active a:after, 
.prodes-tabs.regtabber .nav-tabs>li.active>a:focus:after, 
.prodes-tabs.regtabber .nav-tabs>li.active>a:hover:after {
	background: #7cc242;
}
.regtabber .nav-tabs>li.active>a, 
.regtabber .nav-tabs>li.active>a:focus, 
.regtabber .nav-tabs>li.active>a:hover {
	color: #000;
    cursor: default;
    background-color: transparent;
    border: none;
...
.regtabber .nav>li>a:focus, 
.regtabber .nav>li>a:hover {
	background-color: transparent;
    border: none;
}
.regtabber li a span {
...
.widget.widget-filter-brands ul > li {
	padding: 6px 60px;
}
.shortselect .bootstrap-select > .selectpicker {
	border-radius: 5px;
    border: 1px solid #7cc242;
    background-color: #7cc242;
    color: #fff;
...
.shortselect .bootstrap-select .selectpicker > .filter-option {
	color: #fff;
}
.shortselect {
	max-width: 200px;
...
.proglbtn.grid {
	background-image: url("https://ryants.com/demo/store/template/front/css/../img/gridview-icon.png");
}
.proglbtn.list {
	background-image: url("https://ryants.com/demo/store/template/front/css/../img/listview-icon.png");
}
.proglbtn.active {
	background-color: #7cc242;
	border-color: #7cc242;
...
.proglbtn.grid.active {
	background-image: url("https://ryants.com/demo/store/template/front/css/../img/gridview-icon-active.png");
}
.proglbtn.list.active {
	background-image: url("https://ryants.com/demo/store/template/front/css/../img/listview-icon-active.png");
}

.listviewbtns .shop_probtn{
	width: auto;
	padding: 8px 20px;
}
...
.productdtls_page .product-title {
	font-size: 33px;
	color: #000;
}

.product-single .product-price.prodtlsprice ins {
	font-size: 28px;
	color: #161616;
}
.product-single .product-price.prodtlsprice del {
    color: #c6c6c6;
    font-size: 28px;
}
.disscounttxt {
...
.featured-products-carousel.lfepro .owl-theme .owl-controls {
	display: none;
}
/************************/
...
.profiledtlssection .content-tabs .nav-tabs {
	border-bottom: 1px solid #cecece;
}
.profiledtlssection .content-tabs .nav-tabs > li {
	padding-right: 25px;
	border: none;
}
.profiledtlssection .content-tabs .nav-tabs > li > a {
	margin: 0;
	padding: 0 0 20px;
	border: none;
	position: relative;
}
.profiledtlssection .content-tabs .nav-tabs > li.active > a:after {
    position: absolute;
    content: '';
    width: 100%;
    height: 3px;
...
.profiledtlssection .nav-tabs>li.active>a, 
.profiledtlssection .nav-tabs>li.active>a:focus, 
.profiledtlssection .nav-tabs>li.active>a:hover {
	border: none;
}
.profiledtlssection .nav>li>a:focus, 
.profiledtlssection .nav>li>a:hover {
	background-color: transparent;
    border: none;
}

.orders .carter_table.table > tbody > tr > td.image img{
	width: 60px;
	height: 60px;
	border-radius: 50%;
}
.orders .carter_table .media-link {
	    border-radius: 50%;
}
...
.customradiogroup input[type=radio]:checked + label:after {
	background: #7cc242;
...
.scartdtls_calculation {
	
}
.scartdtls_calculation .shopping-cart {
...
.cartptable > tbody > tr td {
	border-bottom: 1px dashed #ddd;
	padding: 6px 0;
}
.cartptable > tbody > tr > td:last-child,
.cartptable > tfoot > tr > td:last-child {
	text-align: right;
}
.cartptable > tfoot > tr > td {
	padding: 6px 0;
    color: #7cc242;
    border-bottom: 1px dashed #ddd;
}
...
.cartptable > tbody > tr > td:first-child {
...
.all_brands_list li:nth-child(4n+0) {
	border-right: none;
}
.all_brands_list li:nth-child(-n+4) {
...
.vendorlists .thumbnail .media-link {
	height: 260px;
}
...
/***************************/
.productdtls_page .bootstrap-select > .selectpicker {
	background-color: #7cc242;
    color: #fff;
    border-radius: 30px;
	border: none;
}
.productdtls_page .bootstrap-select .selectpicker > .filter-option {
	color: #fff;
}
.productdtls_page .bootstrap-select.open > .selectpicker.dropdown-toggle {
	color: #fff;
    background-color: #404040;
}
.contunie__checkout__btn, .cancelorder__btn {
	display: inline-block;
	border-radius: 5px;
    color: #fff;
    font-size: 15px;
...
.contunie__checkout__btn:hover,
.contunie__checkout__btn:focus {
	background-color: transparent;
	box-shadow: 0 0 0 1px #7cc242;
	color: #7cc242;
}
.cancelorder__btn.blackbg:hover,
.cancelorder__btn.blackbg:focus {
	background-color: transparent;
	box-shadow: 0 0 0 1px #303748;
	color: #303748;
}
...
@media (max-width: 991px) {
	...
	.main-slider-row .padding-lr-0-md {
	    padding-left: 0px !important;
	    padding-right: 0px !important;
	}
	.header .header-cart {
...
@media (max-width: 419px) {
	...
	.halffield, .onethirdfield {
		width: 100%;
	}
	.halffield.borderrirght,
	.onethirdfield.borderrirght {
		border-right: none;
	}
	.proglbtn {
		margin-top: 0;
...
<style media="" data-href="https://ryants.com/demo/store/template/front/css/theme-green-2.css">
Theme Color CSS*
...
.widget.widget-tabs .nav-justified > li.active > a:after,
.widget.widget-tabs .nav-justified > li > a:hover::after,
.widget.widget-tabs .nav-justified > li > a:focus::after {
     position: absolute;
	content: '';
	bottom: -11px;
	left: 45%;
...
.category_menu_search .form-control:focus {
    ...
    -webkit-appearance: 0px 0px 3px #7cc242

;

    -webkit-box-shadow: 0px 0px 3px #7cc242

;

    box-shadow:0px 0px 3px #7cc242
