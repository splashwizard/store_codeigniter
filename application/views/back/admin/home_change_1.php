                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 form-horizontal">
                            ...
                            ?>
								...
								<?php //echo translate('choose_categories_(max_10)');?>
                                    <label class="col-sm-3 control-label" for="demo-hor-3"><?php echo translate('choose_categories');?></label>                
...
function check_cat_length(id,now) {
    ...
    /*if(parent.find("select option:selected").length > 99) {
