                            ...
                            ?> 
                                ...
                                <div class="form-group btm_border">
                                    ...
                                    <div class="col-sm-5">
                                          ...
                                          <textarea rows="9"  class="summernotes" data-height="200" data-name="ad_field_values[]">
                                              
                                              <?php echo $row1['value']; ?></textarea>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="col-sm-12 options margin-bottom-10">
                                                        ...
                                                        foreach ($option as $t => $op1) {
                                                            ...
                                                            ?>
                                                            <div>
                                                                <div class="col-sm-4" name = "<?php echo $t;?>" style="padding-right: 0px;">
                                                                    <input type="text" name="op_set<?php echo $row1['no']; ?>[]" value="<?php echo $op1; ?>" class="form-control required"  placeholder="<?php echo translate('Selection Name'); ?>">
                                                                </div>
                                                                <div class="col-sm-3" style="padding-left: 0px;">
                                                                    <input type="text" name="op_set_value<?php echo $row1['no']; ?>[]" value="<?php echo $option_values[$t]; ?>" class="form-control required"  placeholder="<?php echo translate('Added Cost $'); ?>">
                                                                </div>
                                                                <div class="col-sm-3" style="padding-left: 0px;">
                                                                    <input type="text" name="op_set_number<?php echo $row1['no']; ?>[]" value="<?php echo $option_number[$t]; ?>" class="form-control required"  placeholder="<?php echo translate('Qty. Available'); ?>">
                                                                </div>
                                                                <div class="col-sm-2">
