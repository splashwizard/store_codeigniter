    ...
    <table id="demo-table" class="table table-striped"  data-pagination="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" >
        ...
        foreach($vendor_payments as $row){
            ...
            <tr>
                ...
                <td><?php echo $this->db->get_where('vendor',array('vendor_id'=>$row['vendor_id']))->row()->name; ?></td>
                <td><?php echo $row['total'] ?></td>
                <td><?php echo $row['item_transaction'] ?></td>
                <td><?php echo $row['total_commission'] ?></td>
                <td><?php 
                if($row['total']==0) echo 0;
                else
                    echo rand(0,1)*0.7 ?></td>
