    ...
    <table id="demo-table" class="table table-striped"  data-pagination="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" >
        ...
        <tr>
            ...
            <td class="text-right">
                ...
                <a class="btn btn-info btn-xs btn-labeled fa fa-shopping-cart" href="<?php echo base_url();?>home/vendor_category/<?php echo $row['vendor_id']; ?>/0" target="_blank">

                        <?php echo translate('Vendor Product');?>
