<!--<link rel="stylesheet" href="<?php echo base_url(); ?>template/back/plugins/swichery/style.css">-->
<style>
    /*
 *
...
<div>
    <?php
        echo form_open(base_url() . 'admin/brand/approval_set/'.$brand_id, array(
    ...
    ?>
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                	<h4><?php echo translate('not approved'); ?></h4>
                </div>
                <div class="col-sm-4 text-center">
                	<input id="pub_<?php echo $brand_id; ?>"  class="js-switch" data-size="switchery-lg"  name="approval" type="checkbox" value="ok" data-id='<?php echo $brand_id; ?>' <?php if($status == 'approve'){ ?>checked<?php } ?> />
                </div>
                <div class="col-sm-2">
...
<!--<script src="<?php echo base_url(); ?>template/back/plugins/swichery/swichery.js"></script>--> 

<script src='http://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js'></script>
<!--<script  src="<?php echo base_url(); ?>template/back/plugins/swichery/script.js"></script>-->
<script>
