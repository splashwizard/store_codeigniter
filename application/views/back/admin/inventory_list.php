<div class="panel-body" id="demo_s">
    <table id="demo-table" class="table table-striped"  data-pagination="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" >
        ...
        <tr>
            ...
            <th><div style="text-transform: initial"><?php echo translate('Added by');?></div></th>
            ...
            <tr>
                ...
                <td>
                    <?php
                       ...
                       $l = $this->db->get_where($added_by['type'], array($added_by['type'].'_id' => $added_by['id']))->row()->name;
                    ?>
                    <div style="display: flex">
                        <div><?php  echo $added_by['type'];?></div> :
                        <div><?php  echo $l;?></div>
                    </div>
                ...
                <td><div style="width: 600px;"><?php echo $row['description'];?></div></td>
