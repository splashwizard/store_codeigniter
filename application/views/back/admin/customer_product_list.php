...
<div class="panel-body" id="demo_s">
    <table id="events-table" class="table table-striped"  data-url="<?php echo base_url(); ?>admin/customer_products/list_data" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]"  data-show-refresh="true" data-search="true"  data-show-export="true" >
        <thead>
            <tr>
                ...
                <th data-field="uploaded_by" data-sortable="true">
                    <?php echo translate('uploaded_by');?>
                </th>
                <th data-field="customer_status" data-sortable="false">
