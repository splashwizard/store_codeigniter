    ...
    <div class="row product-single">
        ...
        <div class="col-md-8 col-sm-8 col-xs-12 padding-l-0-md">
            <div class="caption">
                ...
                ?>
                <hr class="page-divider"/>
                <div class="buttons listviewbtns">
                    ...
                    ?>
                    <span class="btn-icon wishlist pal-20 <?php if($wish == 'yes'){ echo 'wished';} else{ echo 'wishlist';} ?>" onclick="to_wishlist(<?php echo $product_id; ?>,event)">
