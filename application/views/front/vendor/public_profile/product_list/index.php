...
<section class="page-section with-sidebar">
    <div class="container">
        <div class="row">
            ...
            <!-- /SIDEBAR -->
            <!-- CONTENT -->
            <div class="col-sm-12 col-xs-12 content" id="content">
                <!-- shop-sorting -->
                <div class="shop-sorting">
                    <div class="row">
                        <div class="col-md-10 col-sm-12 col-xs-12 vendorshort_item">
                            <div class="form-inline">
                                ...
                                <div class="form-group selectpicker-wrapper set_brand shortselect" style="display:none;">
                                </div>
                                <div style="display:none;">
                                    <div class="form-group selectpicker-wrapper set_vendor">
                                    </div>
                                </div>
                                <div class="form-group widget vendorsearch">
                        ...
                        <div class="col-md-2 col-sm-12 col-xs-12 text-right view_select_btn">
                            ...
                            <a class="proglbtn grid mat-0" onClick="set_view('grid')" href="#"><!--<img src="<?php echo base_url(); ?>template/front/img/icon-grid.png" alt=""/>--></a>
                            <a class="proglbtn list mat-0" onClick="set_view('list')" href="#"><!--<img src="<?php echo base_url(); ?>template/front/img/icon-list.png" alt=""/>--></a>
                        </div>
                    </div>
                </div>
                <!-- /shop-sorting -->
                <div id="result" class="vendorlists">
