...
<!--=== Breadcrumbs ===-->
    ...
    ?>
        ...
        <!--Invoice Table-->
        <tr>
            <td style="padding:10px 5px 0px; background:#7cc242; color:white; text-align:center;" colspan="2" >
            ...
            <td style="text-align:right;">
                 <table width="100%">
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;padding:3px"><h2><?php echo $row['grand_total']; ?><?php //echo currency($row['grand_total']);?></h2></td>
                    </tr>
                 </table>
