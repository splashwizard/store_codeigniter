                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="inro-section">
                                ...
                                <div class="proprice spclproprice"><?php echo currency($this->crud_model->get_product_price($row['product_id'])); ?></div>

                            </div>
							<div class="spbottom">
								<button class="speacial_probtn" onclick="to_cart(<?php echo $row['product_id'];?>,event)">Add to Bag</button>
								<span class="btn-icon wishlist pull-right" onclick="to_wishlist(<?php echo $row['product_id'];?>,event)">
