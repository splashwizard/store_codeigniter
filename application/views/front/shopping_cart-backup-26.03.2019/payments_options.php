...
<div class="row">
    ...
    ?>
    <?php //if($balance > $grand) {
            //if($this->crud_model->get_type_name_by_id('general_settings','68','value') == 'ok'){
    ?>
    <div class="cc-selector col-sm-3">
        <input id="mastercarddd" style="display:block;" type="radio" name="payment_type" value="wallet"/>
        <label class="drinkcard-cc" style="margin-bottom:0px; width:100%; overflow:hidden; text-align:center; background:blue;" for="mastercarddd" onclick="radio_check('mastercarddd')">
